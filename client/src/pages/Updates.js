        ...
        <div>
            ...
            <div>
                ...
                <Carousel>
                    ...
                    <div>
                        <img src={kids2} alt="Kids at Race for the cure" />
                        <p className="photos">Will and Gwyn</p>
                    </div>
                    <div>
                        
                        <img src={family} alt="Family at Race for the cure" />
                    ...
                    <div>
                        <img src={kids} alt="Kids at Race for the cure" />
                        <p className="photos">Back row: Gwyn, Issac, Nolan<br></br>
                        Front row: Josie, Will and Bryce</p>
                    </div>

                    <div>
                        <img src={group} alt="Group at Race for the cure" />
                        <p className="photos">Komen Minnesota Race for the Cure</p>
                    </div>
                    <div>
                        <img src={family} alt="Family at Race for the cure" />
                    ...
                    <div>
                        <img src={family1} alt="Family at Race for the cure" />
                        <p className="photos">Komen Minnesota Race for the Cure</p>
                    </div>
                </Carousel>
            </div>
